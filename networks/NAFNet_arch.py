...
class NAFBlock(nn.Module):
    def __init__(self, c, kernel_size=3, DW_Expand=2, FFN_Expand=2, drop_out_rate=0.):
        ...
        self.conv2 = nn.Conv2d(in_channels=dw_channel, out_channels=dw_channel, kernel_size=kernel_size,
...
class NAFNet(nn.Module):
    def __init__(self, img_channel=3, width=32, middle_blk_num=1, enc_blk_nums=[1, 1, 1, 28],
                 ...
                 MultiScale=False, kernel_size=3):
        super().__init__()
...
if __name__ == '__main__':
    ...
    middle_blk_num = 6
    dec_blks = [1, 1, 1, 1]
    net = NAFNet(img_channel=3, width=24, middle_blk_num=middle_blk_num,
